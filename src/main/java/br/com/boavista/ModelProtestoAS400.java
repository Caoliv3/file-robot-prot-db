	...
	public ModelProtestoAS400(String reg) {
		...
		if (!linha[15].equals("")) {
			...
			try {
				...
				getCodigoBusca = String.valueOf(numdd) + String.valueOf(numTel);
				getddd = numdd ;
				getNumTel = Integer.toString(numTel);
...
//		}
	...
	public void setcodCartorioBvs(String cod) {
